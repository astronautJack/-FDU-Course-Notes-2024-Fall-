...
set_property CFGBVS VCCO [current_design];  # Set this based on your project's requirements
set_property CONFIG_VOLTAGE 3.3 [current_design];  # Set this to your configuration bank's voltage
...
# 批量设置输入延迟
set_input_delay -clock [get_clocks sys_clk_pin] -max 2.0 [get_ports {buttonL buttonR reset switch[0] switch[1] switch[2] switch[3] switch[4] switch[5] switch[6] switch[7] switch[8] switch[9] switch[10] switch[11] switch[12] switch[13] switch[14] switch[15]}]
set_input_delay -clock [get_clocks sys_clk_pin] -min 0.5 [get_ports {buttonL buttonR reset switch[0] switch[1] switch[2] switch[3] switch[4] switch[5] switch[6] switch[7] switch[8] switch[9] switch[10] switch[11] switch[12] switch[13] switch[14] switch[15]}]
...
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { A2G[3] }]; #IO_L7P_T2_A26_15 Sch=cd
